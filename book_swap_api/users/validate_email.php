...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        // Generate OTP (1 minute expiry like your system)
        $otp = rand(100000, 999999);
        $otp_expiry = date('Y-m-d H:i:s', strtotime('+1 minutes'));
        
        // Store OTP in users table (using your existing system)
        ...
        if ($otp_stmt->execute()) {
            // Store the pending email change in a separate table
            ...
            // Send OTP email using your existing PHPMailer setup
